    ...
    @extends('layouts-en.app-services-en')

    @section('section-services-en')
        ...
        <!-- main services-en -->
        <h1 class="text-center fw-bold text-danger mt-5 animate__animated animate__zoomIn">There is currently no service</h1>
        <!-- end main services-en -->
